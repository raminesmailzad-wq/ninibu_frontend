# Ninibu Frontend v0.19.0 — Docker deployment
...
The default image tag is `ninibu-frontend:0.19.0`. Override it when needed:

```bash
NINIBU_FRONTEND_IMAGE=registry.example/ninibu-frontend:0.19.0 docker compose up -d
```
