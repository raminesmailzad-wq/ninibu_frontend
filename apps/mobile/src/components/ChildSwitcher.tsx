...
const s=StyleSheet.create({box:{flexDirection:'row-reverse',alignItems:'center',gap:10,backgroundColor:'#fff',borderWidth:1,borderColor:colors.border,borderRadius:18,padding:10},avatar:{width:40,height:40,borderRadius:13,backgroundColor:colors.primarySoft,alignItems:'center',justifyContent:'center'},tiny:{fontSize:9.5,color:colors.muted,textAlign:'right'},name:{fontSize:12.5,fontWeight:'900',color:colors.foreground,textAlign:'right',writingDirection:'rtl'},date:{fontSize:9,color:colors.primary,textAlign:'right',marginTop:2,writingDirection:'rtl'}});
